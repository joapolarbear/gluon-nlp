...
parser.add_argument('--data_eval', type=str, default='/data/book-corpus/book-corpus-large-split/*.test,/data/enwiki/enwiki-feb-doc-split/*.test',
...
[(256, 512), (256, 80), (256, 80), (256, 80), (256,), (256, 512), (256,)]

sym = model.bert._cached_graph[1]
outputs = sym.get_internals().list_outputs()
arg_dict = {}
for idx, shape_ in enumerate(data_shapes):
    if idx not in [1, 2, 3]:
        arg_dict["data%d"%len(arg_dict)] = shape_
arg_shapes, out_shapes, aux_shapes = sym.get_internals().infer_shape(**arg_dict)
